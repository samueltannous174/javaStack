...
<h1 class="text-4xl font-bold text-gray-800">Create Book</h1>



<div class="flex w-full justify-center mt-8">
    <form:form action="/create_book" method="post" cssClass="bg-blue-100 shadow-lg p-8 flex flex-col gap-6 w-full max-w-md rounded-lg" modelAttribute="book">
