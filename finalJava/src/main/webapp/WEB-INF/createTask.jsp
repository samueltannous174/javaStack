...
<body class=" min-h-screen flex flex-col items-center gap-12 bg-blue-50">
...
<h1 class="text-4xl font-bold text-gray-800">Create Task</h1>



<div class="flex w-full justify-center mt-8">
    <form:form action="/create_task" method="post" cssClass="bg-blue-100 shadow-lg p-8 flex flex-col gap-6 w-full max-w-md rounded-lg" modelAttribute="task">
        ...
        <input name="selectedTag" value="-1" type="hidden">


        <input type="submit" value="Submit" class="bg-purple-900 text-white rounded py-2 mt-4 hover:bg-blue-700 cursor-pointer"/>
    </form:form>
