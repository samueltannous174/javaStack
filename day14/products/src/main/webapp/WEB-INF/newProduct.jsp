...
<h1 class="text-4xl font-bold text-gray-800">New Product</h1>

<div class="flex w-full justify-center mt-8">
    <form:form action="/create_product" method="post" cssClass="bg-white shadow-lg p-8 flex flex-col gap-6 w-full max-w-md rounded-lg" modelAttribute="product">
        ...
        <div class="flex flex-col gap-1">
            ...
            <form:input path="description" class="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
        </div>
        <div class="flex flex-col gap-1">
            <form:label path="price" class="font-medium">Price :</form:label>
            <form:errors path="price" cssClass="text-red-600 text-sm"/>
