...
<form action="/add_product" method="post">
    ...
    <div class="flex flex-col gap-1">
        <label for="product" class="font-medium">Select Category:</label>
        <select name="product" id="product" class="border border-gray-300 rounded px-3 py-2 w-full">
    ...
    <input type="submit" value="Add Product" class="bg-blue-600 text-white rounded py-2 mt-4 hover:bg-blue-700 cursor-pointer"/>
</form>
